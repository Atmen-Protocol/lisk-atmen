...
import { UINT256_LENGTH, CLOAK_MODULE_NAME } from "./constants";
...
export class InternalMethod extends BaseMethod {
    ...
    public async _openSwap(methodContext: MethodContext, swapID: Buffer, swap: Swap): Promise<void> {
        ...
        this._tokenMethod.lock(methodContext, swap.senderAddress, CLOAK_MODULE_NAME, swap.tokenID, swap.value);
    ...
    public async _closeSwap(methodContext: MethodContext, swapID: Buffer, secretKey: Buffer): Promise<void> {
        ...
        this._tokenMethod.unlock(methodContext, swap.senderAddress, CLOAK_MODULE_NAME, swap.tokenID, swap.value);
